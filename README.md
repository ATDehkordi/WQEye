🛑 **important**: The paper is currently under review. So, the repository is not a complete version of WQEye. The full code will be available upon the acceptance of the paper. For software illustration, refere to [here](docs/Step-by-Step.pdf)
